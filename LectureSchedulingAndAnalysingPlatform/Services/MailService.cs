...
namespace LectureSchedulingAndAnalysingPlatform.Services
{
    public class MailService : IMailService
    {
        ...
        public async Task SendApprovalEmailAsync(ApprovalRequest request)
        {
            string FilePath = Directory.GetCurrentDirectory() + "\\Templates\\LectureHallTemplate.html";
            ...
            email.Subject = $"Requesting the reservation of {request.Hall}";
